...
/*
*   Stub bytes, useful for generi replies, these represent the 
*   first byte un the fixed header
*/
...
int mqtt_encode_lenght(unsigned char *, size_t);
...
struct mqtt_suback *mqtt_packet_suback(unsigned char, unsigned short, unsigned short *, unsigned short);
